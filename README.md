...
- `loads/process_response_data.py:` Функции validate_response_format и process_response_data обрабатывают и валидируют входные данные, извлекая информацию о ментерах, открытках и праздниках, а затем проверяют их формат на соответствие ожидаемой модели.
