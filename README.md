...
- `loads/process_response_data.py:` Функции validate_response_format и process_response_data обрабатывают и валидируют входные данные, извлекая информацию о наставниках, открытках и праздниках, а затем проверяют их формат на соответствие ожидаемой модели.
- `loads/response_data.py:` Модуль для взаимодействия с API.
- `loads/models.py:` Определяет Pydantic-модели данных для менторов, открыток и праздников.
